...
public partial class App : Application
{
    ...
    public static Uri LangPath = new("avares://JPDA/Assets/Lang/en.axaml");
    public static int CurrentScreenId = 0;
    
    public static int LangId = 0;
    public static int MenuButtonAlign = 0;
    public static bool TargetEng = true;
    public static bool TargetRus = false;

    public static string KanjiInputText = "";
    ...
    {
        CurrentApplicationLifetime = ApplicationLifetime;
    ...
    public static void ResetViews(int screenId)
    {
